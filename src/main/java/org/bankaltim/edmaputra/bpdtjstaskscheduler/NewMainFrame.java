...
public class NewMainFrame extends JFrame {
	...
	private void startScheduler() {
		try {
			...
			if (!mainPanel2.getTxtJam().getText().isEmpty()) {
				...
				Trigger trigger2 = setTrigger(job2, mainPanel2.getTxtJam().getText(), mainPanel2.getTxtMenit().getText(),
						mainPanel2.getTriggerName(), mainPanel2.getTriggerGroup());
			...
			if (!mainPanel3.getTxtJam().getText().isEmpty()) {
				...
				Trigger trigger3 = setTrigger(job3, mainPanel3.getTxtJam().getText(), mainPanel3.getTxtMenit().getText(),
						mainPanel3.getTriggerName(), mainPanel3.getTriggerGroup());
			...
			if (!mainPanel4.getTxtJam().getText().isEmpty()) {
				...
				Trigger trigger4 = setTrigger(job4, mainPanel4.getTxtJam().getText(), mainPanel4.getTxtMenit().getText(),
						mainPanel4.getTriggerName(), mainPanel4.getTriggerGroup());
			...
			if (!mainPanel5.getTxtJam().getText().isEmpty()) {
				...
				Trigger trigger5 = setTrigger(job5, mainPanel5.getTxtJam().getText(), mainPanel5.getTxtMenit().getText(),
						mainPanel5.getTriggerName(), mainPanel5.getTriggerGroup());
			...
			if (!mainPanel6.getTxtJam().getText().isEmpty()) {
				...
				Trigger trigger6 = setTrigger(job6, mainPanel6.getTxtJam().getText(), mainPanel6.getTxtMenit().getText(),
						mainPanel6.getTriggerName(), mainPanel6.getTriggerGroup());
	...
	private int validasiPerTask() {
		...
		if (!mainPanel1.getTxtJam().getText().isEmpty()) {
			if (validateWaktu(mainPanel1.getTxtJam(), mainPanel1.getTxtMenit()) == false) {
				errorCode = 2;
			}
		}

		if (!mainPanel2.getTxtJam().getText().isEmpty()) {
			if (validateWaktu(mainPanel2.getTxtJam(), mainPanel2.getTxtMenit()) == false) {
				errorCode = 2;
			}
		}

		if (!mainPanel3.getTxtJam().getText().isEmpty()) {
			if (validateWaktu(mainPanel3.getTxtJam(), mainPanel3.getTxtMenit()) == false) {
				errorCode = 2;
			}
		}

		if (!mainPanel4.getTxtJam().getText().isEmpty()) {
			if (validateWaktu(mainPanel4.getTxtJam(), mainPanel4.getTxtMenit()) == false) {
				errorCode = 2;
			}
		}

		if (!mainPanel5.getTxtJam().getText().isEmpty()) {
			if (validateWaktu(mainPanel5.getTxtJam(), mainPanel5.getTxtMenit()) == false) {
				errorCode = 2;
			}
		}

		if (!mainPanel6.getTxtJam().getText().isEmpty()) {
			if (validateWaktu(mainPanel6.getTxtJam(), mainPanel6.getTxtMenit()) == false) {
				errorCode = 2;
			}
		}
